...
import '../Models/nearByPlacePredictions.dart';
...
class _SearchScreenState extends State<SearchScreen>
{
  ...
  List<NearByPlacePredictions> placePredictionsList = [];


  @override
  Widget build(BuildContext context)
  {
    var currentLocation = Provider.of<AppData>(context).pickUpLocation ;
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: TextField(
                              onChanged: (val)
                              {
                                findNearByPlace(val, currentLocation!);
                              },
                              style: TextStyle(fontSize: 15,color: Colors.black),
 ...
 void findNearByPlace(String placeName, Address Location ) async
 {
   if(placeName.length >1)
   {
     var nearByUrl = Uri.parse("https://maps.googleapis.com/maps/api/place/textsearch/json?query=$placeName&location=${Location.latitude},${Location.longitude}&rankby=distance&type=hospital&language=ar&key=$mapKey&sessiontoken=1234567890&components=country:eg");
     var response = await RequestAssistant.getRequest(nearByUrl);
     ...
     if(response["status"] == "OK")
     {
       ...
       var placesList = (predictions as List).map((e) => NearByPlacePredictions.fromJson(e)).toList();
       setState(() {
...
class PredictionTile extends StatelessWidget
{
  ...
  final NearByPlacePredictions placePredictions;
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      //SizedBox(height: 8.0,),
                      Text(placePredictions.name!, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 18.0),),
                      SizedBox(height: 3.0,),
